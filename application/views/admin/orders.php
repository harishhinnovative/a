...
?>
                                    <tr>
                                      ...
                                      <?php  } ?>
                                       ...
                                       <td>
                                       <a class="btn btn-sm btn-info" title="Ship"
                                                   href="<?php echo admin_url() . 'sales/orderStatus/' . $order->order_id.'/shipped/orders'; ?>"><i
                                                            class="fa fa-eye-slash btn-warning"></i></a>
                                        <a class="btn btn-sm btn-warning" title="Cancel"
                                                   href="<?php echo admin_url() . 'sales/orderStatus/' . $order->order_id.'/cancelled/orders'; ?>"><i
