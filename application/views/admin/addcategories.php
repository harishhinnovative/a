                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="add-product-form-group">
                                    ...
                                    <?php } ?>
                                    <h3>Category Info</h3>
                                    <form method="post" action="<?php echo admin_url(); ?>catalog/addCategory"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <p>
                                                    ...
                                                    <a href="<?php echo base_url("admin/catalog/categories");?>" class="btn btn-danger">
                                        ...
                                        <div class="col-md-12">
                                            <div class="product-upload-action">
                                                <div class="product-upload btn btn-info">
                                                    ...
                                                    <input type='file' name="cat_img" onchange="readURL(this);" required/>
